...
cat("  Ingroup taxa only:",nrow(subset(results, results$both==1 & results$in.q.mono==1)),"\n")
cat("  Outgroup taxa only:",nrow(subset(results, results$both==1 & results$out.q.mono==1)),"\n")
