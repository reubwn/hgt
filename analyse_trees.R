...
cat("  Ingroup:",nrow(subset(results, results$both==1 & results$in.q.mono)),"\n")
cat("  Outgroup:",nrow(subset(results, results$both==1 & results$out.q.mono)),"\n")
cat("  Both:",nrow(subset(results, results$both==1 & results$in.q.mono & results$out.q.mono)),"\n")
...
cat("Number of trees with 'strong' HGT support:\n")
cat("  ",nrow(subset(results,results$ntax.in>=3 & results$ntax.out>=3 & results$in.q.mono==0 & results$out.q.mono==1)),"\n")
cat("Defined as clusters with at least 3 each in/outgroup taxa, where monophyly with outgroup taxa is possible but with ingroup taxa is not possible\n\n")
cat("Number of trees where Query can be monophyletic with (well-supported in parentheses):\n")
cat("  Metazoa: ",sum(results$euk.metazoa.q.mono)," (",nrow(subset(results,results$ntax.in>=3 & results$ntax.out>=3 & results$in.q.mono==0 & results$out.q.mono==1 & results$euk.metazoa.q.mono)),")","\n",sep="")
cat("  Fungi: ",sum(results$euk.fungi.q.mono)," (",nrow(subset(results,results$ntax.in>=3 & results$ntax.out>=3 & results$in.q.mono==0 & results$out.q.mono==1 & results$euk.fungi.q.mono)),")","\n",sep="")
cat("  plants: ",sum(results$euk.plants.q.mono)," (",nrow(subset(results,results$ntax.in>=3 & results$ntax.out>=3 & results$in.q.mono==0 & results$out.q.mono==1 & results$euk.plants.q.mono)),")","\n",sep="")
cat("  other eukaryotes: ",sum(results$euk.other.q.mono)," (",nrow(subset(results,results$ntax.in>=3 & results$ntax.out>=3 & results$in.q.mono==0 & results$out.q.mono==1 & results$euk.other.q.mono)),")","\n",sep="")
cat("  Bacteria: ",sum(results$bacteria.q.mono)," (",nrow(subset(results,results$ntax.in>=3 & results$ntax.out>=3 & results$in.q.mono==0 & results$out.q.mono==1 & results$bacteria.q.mono)),")","\n",sep="")
cat("  Archaea: ",sum(results$archaea.q.mono)," (",nrow(subset(results,results$ntax.in>=3 & results$ntax.out>=3 & results$in.q.mono==0 & results$out.q.mono==1 & results$archaea.q.mono)),")","\n\n",sep="")
